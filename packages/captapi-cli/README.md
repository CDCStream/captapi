...
structured social-media data from 32 platforms (YouTube, TikTok, Instagram,
...
captapi list                  # every endpoint (177 commands)
...
| `captapi <endpoint> [flags]` | Call any of the 177 data endpoints |
