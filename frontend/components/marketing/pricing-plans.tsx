...
function subscriptionTiers(cycle: "monthly" | "yearly"): PricingTier[] {
  ...
  return [
    ...
    },
    {
      ...
      features: [
        `${PLAN_CREDITS.starter.toLocaleString()} credits / month`,
        "120 requests / minute",
        "All 34 APIs included",
        "Email support",
      ],
    },
    {
      ...
      href: planParam("pro"),
      features: [
        `${PLAN_CREDITS.pro.toLocaleString()} credits / month`,
        "300 requests / minute",
        "Priority support",
        "Bulk endpoints (beta)",
      ],
    },
    {
      ...
      features: [
        `${PLAN_CREDITS.business.toLocaleString()} credits / month`,
        "600 requests / minute",
        "Slack support + SLA",
        "Custom rate limits",
      ],
...
const paygTiers: PricingTier[] = [
  {
    ...
    price: starterPrice,
    period: " one-time",
    description: `${PACKS.starter.credits.toLocaleString()} credits`,
    color: "blue",
    cta: "Buy now",
  ...
  },
  {
    ...
    price: growthPrice,
    period: " one-time",
    description: `${PACKS.growth.credits.toLocaleString()} credits`,
    color: "amber",
    popular: true,
    cta: "Buy now",
  ...
  },
  {
    ...
    price: scalePrice,
    period: " one-time",
    description: `${PACKS.scale.credits.toLocaleString()} credits`,
    color: "purple",
    cta: "Buy now",
