...
This is the complete, machine-readable endpoint reference for Captapi: one API for structured data from ${PLATFORM_COUNT} platforms — YouTube, TikTok, Instagram, Facebook, Twitter/X, Reddit, Threads, Bluesky, Pinterest, LinkedIn, Rumble, Twitch, Spotify, SoundCloud, Linktree, Snapchat, Truth Social, Kick, Amazon Shop, Kwai, Komi, Pillar, Linkbio, Linkme, and more (transcripts, AI summaries, comments, details, profile/channel stats, search, commerce intelligence, and ad libraries). It returns clean JSON, needs no OAuth, and a single key works across all platforms. ${ALL_ENDPOINTS.length} endpoints total. The shorter overview is at ${base}/llms.txt.
...
5. Use \`limit\` conservatively for list/search/comment endpoints. Pass cache=true for a free 24h cache hit (default is always fresh). Many native list/search/comment calls are flat 2 credits (YouTube comments/search/channel-videos/playlists, TikTok comments/channel-posts/top-search/trending-feed, Instagram hashtag-search, Twitter/X user-tweets/search, Reddit list/search/comments). Other list endpoints may still scale by result count — see each endpoint's Cost line.
