...
const PLATFORM_BG: Record<PlatformId, string> = {
  ...
  facebook_marketplace: "bg-blue-600/10",
  facebook_events: "bg-blue-600/10",
  facebook_ad_library: "bg-blue-600/10",
  tiktok_ad_library: "bg-pink-500/10",
  google_ad_library: "bg-amber-500/10",
  linkedin_ad_library: "bg-blue-700/10",
  github: "bg-foreground/10",
  twitch: "bg-purple-500/10",
  spotify: "bg-green-500/10",
  soundcloud: "bg-orange-500/10",
  linktree: "bg-lime-500/10",
  snapchat: "bg-yellow-500/10",
  truth_social: "bg-red-700/10",
  kick: "bg-green-500/10",
  amazon_shop: "bg-amber-500/10",
  account: "bg-emerald-500/10",
  utilities: "bg-slate-500/10",
  kwai: "bg-orange-500/10",
  komi: "bg-violet-500/10",
  pillar: "bg-cyan-500/10",
  linkbio: "bg-pink-500/10",
  linkme: "bg-blue-500/10",
};
...
const PLATFORM_FG: Record<PlatformId, string> = {
  ...
  facebook_events: "text-blue-600",
  facebook_ad_library: "text-blue-600",
  tiktok_ad_library: "text-pink-500",
  google_ad_library: "text-amber-600",
  linkedin_ad_library: "text-blue-700",
  github: "text-foreground",
  twitch: "text-purple-500",
  spotify: "text-green-500",
  soundcloud: "text-orange-500",
  linktree: "text-lime-500",
  snapchat: "text-yellow-500",
  truth_social: "text-red-700",
  kick: "text-green-500",
  amazon_shop: "text-amber-500",
  account: "text-emerald-600",
  utilities: "text-slate-600",
  kwai: "text-orange-500",
  komi: "text-violet-500",
  pillar: "text-cyan-600",
  linkbio: "text-pink-500",
  linkme: "text-blue-500",
};
