...
export const USE_CASES: Record<string, UseCase> = {
  "ai-startups": {
    ...
    metaDescription:
      "Feed clean transcripts, summaries, comments, profiles, and search results into your RAG pipeline, fine-tuning dataset, or AI agent. One REST API across 32 platforms.",
  ...
  agencies: {
    ...
    metaDescription:
      "Track competitor content, monitor brand mentions, analyze sentiment, and research ads or commerce across 32 platforms with one social media data API.",
    keyword: "social media monitoring api",
    h1: "Social media data API for agencies & brands",
    intro:
      "Captapi gives agencies and brands a single API to track competitor content, monitor mentions, research ads and commerce, and analyze engagement across 32 platforms — comments, summaries and metrics in clean JSON, ready for your dashboards and reports.",
    builds: [
    ...
    faqs: [
      {
        ...
        a: "Yes. Captapi covers 32 platforms through a single REST API, so you can collect content, comments, search results, profiles, ad intelligence, commerce data and engagement metrics without juggling separate integrations.",
      },
      {
  ...
  researchers: {
    ...
    metaDescription:
      "Bulk-export comments, transcripts, search results, profiles and metadata for trend analysis, OSINT and academic studies across 32 platforms.",
    keyword: "social media data for research",
    h1: "Social media data API for researchers & journalists",
    intro:
      "Captapi helps researchers and journalists collect public social data at scale — comments, transcripts, search results, profiles, video details and engagement metrics across 32 platforms — in clean JSON ready for analysis, with no scraping infrastructure to maintain.",
    builds: [
